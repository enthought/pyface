...
# local imports
from sheet_model import SheetModel, SheetRow

class CompositeSheetModel(SheetModel):
    """ A CompositeSheetModel is a model whose underlying data is
    a collection of other sheet models. """
    
    # The models this model is comprised of.
    data = List(SheetModel)
    
    # The rows in the model. 
    rows = Trait(None, None, List(SheetRow))
    ...
    def __init__(self, **traits):
        """ Create a CompositeSheetModel object. """

        # Base class constructor
        super(CompositeSheetModel, self).__init__(**traits)
    ...
    def get_column_count(self):
        ...
        # for the composite sheet model, this is simply the sum of the
    ...
    def _resolve_column_index(self, index):
        ...
        real_index = index
        cached = self._data_index.get(index)
