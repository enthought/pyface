...
# We specify the same info for rows and for columns, but add a SheetColumn
# name for clarity.
SheetColumn = SheetRow

class SheetSortData(HasTraits):
...
SheetSortEvent = SheetSortData

class SheetModel(HasPrivateTraits):
    """ Model for sheet views. """
    ...
    def __init__(self, **traits):
        ...
        super(SheetModel, self).__init__(**traits)
        
        return
    
    #########################################################################
    # 'SheetModel' interface -- Subclasses MUST override the following
    #########################################################################
    ...
    #########################################################################
    # 'SheetModel' interface -- Subclasses MAY override the following
    #########################################################################
    ...
    def get_cols_selection_value(self, cols):
        ...
        going on in the sheet. rows is a list of row indexes. """
    ...
    def set_value(self, row, col, value):
        ...
        """
        #print 'SheetModel.set_value row: ', row, ' col: ', col, ' value: ', value
    ...
    #########################################################################
    # 'SheetModel' interface -- Subclasses MAY NOT override the following
    #########################################################################
    ...
    #########################################################################
    # protected 'SheetModel' interface -- Subclasses should override these
