...
#------------------------------------------------------------------------------
""" A SimpleSheetModel simply builds a table from a 2-dimensional
...
# local imports
from sheet_model import SheetColumn, SheetModel, SheetRow

class SimpleSheetModel(SheetModel):
    """ A SimpleSheetModel simply builds a table from a 2-dimensional
    list/array containing the data. Optionally users can pass in specifications
    for rows and columns. By default these are built off the data itself,
    with row/column labels as the index + 1."""
    ...
    columns = Trait(None, None, List(SheetColumn))

    #########################################################################
    # 'object' interface.
    #########################################################################
    def __init__(self, **traits):
        """ Create a SimpleSheetModel object. """

        # Base class constructor
        super(SimpleSheetModel, self).__init__(**traits)
