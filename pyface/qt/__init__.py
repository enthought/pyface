...
if qt_api is None:
    for api_name, module in QtAPIs:
        ...
        raise ImportError("Cannot import PySide2, or PyQt5")

# otherwise check QT_API value is valid
elif qt_api not in {api_name for api_name, module in QtAPIs}:
    msg = (
        "Invalid Qt API %r, valid values are: 'pyside2' or 'pyqt5'"
    ) % qt_api
...
is_qt4 = False
is_qt5 = True
is_pyside = (qt_api.startswith('pyside'))
is_pyqt = (qt_api.startswith('pyqt'))
