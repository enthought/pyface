...
class WorkbenchWindowLayout(MWorkbenchWindowLayout):
    ...
    def close(self):
        ...
        self._qt4_editor_area.hasFocus.disconnect(self._qt_editor_focus)
    ...
    def _qt4_create_view_dock_widget(self, view, size=(-1, -1)):
        ...
        try:
            ...
            dw.toggleViewAction().toggled.connect(self._qt4_handle_dock_visibility, 'bool')
            #dw.connect(dw, QtCore.SIGNAL('visibilityChanged(bool)'),
            #        self._qt4_handle_dock_visibility)
            dw.visibilityChanged.connect(self._qt4_handle_dock_visibility, 'bool')
