...
class EditorAreaWidget(QtGui.QMainWindow):
    ...
    def __init__(self, editor_area, parent=None):
        ...
        QtGui.QApplication.instance().focusChanged.connect(self._focus_updated)
    ...
    def _remove_event_listeners(self):
        ...
        app.focusChanged.disconnect(self._focus_updated)
        ...
        if event.polished():
            ...
            if isinstance(child, QtGui.QTabBar):
                ...
                child.currentChanged.connect(
                    self._tab_index_updated, QtCore.Qt.UniqueConnection
                )
    ...
    def _focus_updated(self, old, new):
    ...
    def _tab_index_updated(self, index):
